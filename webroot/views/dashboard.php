...
?>
            ...
            <!-- PAGE CONTENT -->
            <div class="content">
                <section duty="main-content" class="xcontent col-lg-12 col-md-12 col-sm-12">
                    ...
                    <aside duty="income-expenses" class="col-lg-12 col-md-12 col-sm-12 marg">
                        <div duty="income-expenses-chart" class="shade chart-container">
                            ...
                            <div class="col-lg-12 totals">
                                <div class="col-lg-6 col-md-6 col-sm-12 left-total">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 right-total">
                    ...
                    <aside duty="essentials" class="essentials col-lg-12 col-md-12 col-sm-12 marg">
                        <div duty="income-expenses-chart" class="shade chart-container col-lg-12 col-md-12 col-sm-12" style="display:inline-block;">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <h4 class="sect-header">Bucket Proportions</h4>
                            </div>

                            <div duty="income-piechart" class="paddoff col-lg-6 col-md-6 col-sm-6" style="float: left; height: 43vh;">
                                <canvas id="incomePieChart"></canvas>
                            </div>

                            <div duty="expenses-piechart" class="paddoff col-lg-6 col-md-6 col-sm-6" style="float: left; height: 43vh;">
                                <canvas id="expensesPieChart"></canvas>
                            </div>
                        </div>
                    </aside>

                    <aside class="col-lg-12 col-md-12 col-sm-12 marg">
                        <div duty="essentials" class="essens-marg shade col-lg-4 col-md-12 col-sm-12" style="float: left;">
                        ...
                        <div duty="month-calendar" class="essens-marg shade col-lg-4 col-md-12 col-sm-12" style="float: right;">
                            <h4 class="chart-header">Essentials</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates qui eos ipsam aut! Sit, quas. Amet dolorum, et corporis provident consequatur quidem temporibus dolores unde impedit autem. Eos, incidunt expedita.</p>
                        </div>

                        <div duty="month-calendar" class="shade col-lg-4 col-md-12 col-sm-12" style="float: right;">
                            <h4 class="chart-header">Essentials</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptates qui eos ipsam aut! Sit, quas. Amet dolorum, et corporis provident consequatur quidem temporibus dolores unde impedit autem. Eos, incidunt expedita.</p>
                        </div>
                    </aside>
