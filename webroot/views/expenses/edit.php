                ...
                <section duty="main-content" class="xcontent">
                    ...
                    <aside class="col-lg-12 marg">
                        <div duty="expenses-entry" class="shade col-lg-12">
                            ...
                            <?php 
                                $attributes = array('id' => 'expenses-update-form');     //Create main form attributes
                                echo form_open("expenses/update/" . $content->id, $attributes);    //Create form and set attributes
                                //die(print_r($content));
                            ?>
