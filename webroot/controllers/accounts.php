    ...
    class Accounts extends CI_Controller {
        ...
        public function update_details () {
            ...
            if ($this->form_validation->run() == FALSE) {       //if it hasn't submitted or there are erros
                ...
                if($this->User_model->update_details($cheynId)) {           //Try update the details
        ...
        public function change_password () {
            ...
            if ($this->form_validation->run() == FALSE) {       //if it hasn't submitted or there are erros
                ...
                if($this->User_model->verify_password($cheynId)) {           //Verify the current password

                    if($this->User_model->change_password($cheynId)) {           //Try update the password
